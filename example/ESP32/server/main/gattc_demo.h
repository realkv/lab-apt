...
enum
{
	KDE_SVC_HDL,     		               /* KDE service declaration */

    KDE_TX_CH_HDL,                         /* KDE tx characteristic */ 
    KDE_TX_HDL,                            /* KDE tx data */
    KDE_TX_CH_CCC_HDL,                     /* KDE tx client characteristic1 configuration */

	KDE_RX_CH_HDL,                         /* KDE rx characteristic */ 
    KDE_RX_HDL,                            /* KDE rx data */
